        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a href="{{route('payment.create')}}" class="btn btn-sm btn-neutral">Tambah Payment</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    <h3 class="mb-0">Daftar Payment</h3>
                </div>
                <!-- Light table -->
                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="bank">Nama Bank</th>
                                <th scope="col" class="sort" data-sort="harga_produk">No Rekening</th>
                                <th scope="col" class="sort" data-sort="stok_produk">Nama</th>
                        ...
                        <tbody class="list">
                            ...
                            <div class="modal fade" id="exampleModal-{{$key->id}}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form action="{{route('payment.destroy', [$key->id])}}" method="post">
                                        @csrf
                                        @method('delete')
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h3>
                                                    Yakin menghapus data {{ $key->bank }} {{ $key->name }} ?
                                                </h3>
                                            </div>
