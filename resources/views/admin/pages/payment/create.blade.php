                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Form Tambah Payment</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    <h3 class="mb-0">Form Tambah Payment</h3>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="bank" value="{{ old('bank') }}" placeholder="Masukkan Nama Bank" />
                            </div>
                            <div class="col-lg-6">
                                <label>No Rekening</label>
                                <input type="text" class="form-control" name="no_rekening" value="{{ old('no_rekening') }}" placeholder="Masukkan No Rekening" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-6">
