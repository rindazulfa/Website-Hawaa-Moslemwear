                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="/bahan_baku">Daftar Bahan Baku</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Form Tambah Bahan Baku</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="satuan" readonly value="Meter" placeholder="Masukkan Satuan">
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <button type="button" class="btn btn-secondary"><a href="{{route('bahan_baku.index')}}">Kembali</a></button>
                            </div>
                        </div>
                    </div>
                </form>
