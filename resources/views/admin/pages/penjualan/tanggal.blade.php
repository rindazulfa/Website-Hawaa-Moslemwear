    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <form class="form" method="post" action="{{ route('penjualan.update', [$DP->id]) }}">
                    @csrf
                    {{method_field("PUT")}}
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <button type="button" class="btn btn-secondary"><a href="{{route('penjualan.index')}}">Cancel</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
