                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="nama_produk">Email</th>
                                <th scope="col" class="sort" data-sort="harga_produk">Password</th>
                        ...
                        <tbody class="list">
                            <tr>
                                ...
                                <td class="stok_produk">rikcy123</td>
                                <td class="stok_produk">ADMIN</td>
                                <td class="aksi">
