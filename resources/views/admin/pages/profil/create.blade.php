        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Form Profil UMKM</h6>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <button type="button" class="btn btn-secondary"><a href="{{route('profilumkm.index')}}">Kembali</a></button>
                            </div>
                        </div>
                    </div>
                </form>
