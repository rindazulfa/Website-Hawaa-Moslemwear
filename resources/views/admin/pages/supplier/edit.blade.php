                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Form Ubah Supplier</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    <h3 class="mb-0">Form Ubah Supplier</h3>
                </div>
                <form class="form" method="post" action="{{route('supplier.update',[$page->id])}}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 mt-4">
                                <label>Telepon</label>
                                <input type="number" class="form-control" value="{{ $page->phone }}" name="phone" placeholder="Masukkan Telepon" />
                            </div>
                        </div>
