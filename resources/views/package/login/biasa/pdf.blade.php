  ...
  <body>
    <header class="clearfix">
      ...
      <div id="company" class="clearfix">
        ...
        <div>Jl ketintang wiyata 1 no. 25<br /> Surabaya</div>
        <div>08113104430</div>
        <div><a href="mailto:hawaamoslemwear@gmail.com">hawaamoslemwear@gmail.com</a></div>
      </div>
      <div id="project">
        <div><span>Nama Customer</span></div>
        <div><span>Telepon</span> John Doe</div>
